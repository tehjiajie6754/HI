...
function Iridescence({ color = [1, 1, 1], speed = 1.0, amplitude = 0.1, mouseReact = true, ...rest }: any) {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  useEffect(() => {
    ...
    const handleContextRestored = () => { isContextLost = false; };
    ...
    function update(t: number) {
      if (isContextLost) { animateId = requestAnimationFrame(update); return; }
      try {
